...
## Specialty
La especialidad nace en estado inactivo, cuando se le agreguen tratamientos "ACTIVOS" pasaría a estado Activo.

### Atributos
- Id: GUID (Identidad interna de la clínica)
- Name: VO (único en el sistema)
- Description: string (Opcional)
- Status: SpecialtyStatus (estado lógico DRAFT, ACTIVE, ARCHIVED)
...
## Treatment
- Code: TreatmentCode (VO) - Código del nomenclador odontológico. - Inmutable y único dentro de la especialidad.
Name: Name (VO) Nombre del tratamiento
- BaseCost: Money (VO) - Costo base del tratamiento. Puede ser 0, no negativo, con moneda.
- Status: TreatmentStatus - Estado lógico. ACTIVE / ARCHIVED (ACTIVE por default)
